...
for all (q, e) pairs in results-Tmax. One figure per quantity, 10x3 grid.

Usage: python plot_Tcut.py [--quick]
...
def main():
    ...
    for qty, ylabel, outname in quantities:
        ...
        # Left: q=0.2, vary e (different lines)
